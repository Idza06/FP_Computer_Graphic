...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure EyedropBtnClick(Sender: TObject);
...
procedure TForm1.EyedropBtnClick(Sender: TObject);
begin
...
procedure TForm1.LineBoxClick(Sender: TObject);
begin
...
procedure TForm1.MoveBoxClick(Sender: TObject);
begin
...
procedure TForm1.RotateBoxClick(Sender: TObject);
begin
...
procedure TForm1.ScaleBoxClick(Sender: TObject);
begin
